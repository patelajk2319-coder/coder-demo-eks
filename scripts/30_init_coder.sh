...
echo -e "\033[0;32m  │  Coder URL (VPC-internal):  ${CODER_ACCESS_URL}\033[0m"
echo -e "\033[0;32m  │  Local access:               ${LOCAL_CODER_URL}\033[0m"
echo -e "\033[0;32m  │  Admin user:                 ${CODER_ADMIN_EMAIL}\033[0m"
echo -e "\033[0;32m  └──────────────────────────────────────────────────────────────┘\033[0m"
echo ""
